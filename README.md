...
```
#include <stdio.h>
int main() { int d, m, y; int daysInMonth;
scanf("%d/%d/%d", &d, &m, &y);
if (y <= 0) {
    printf("Invalid Date\n");
    return 0;
...
```
# Output:
<img width="1480" height="821" alt="image" src="https://github.com/user-attachments/assets/b1015f2f-6963-49f7-b3df-60f92fd7daee" />
...
```
# Output:
<img width="1536" height="361" alt="image" src="https://github.com/user-attachments/assets/a183746e-c1a6-4577-85bc-5c792a93ce65" />
...
```
# Output:
<img width="1682" height="491" alt="image" src="https://github.com/user-attachments/assets/3f8b69e1-6c61-43e3-b0fd-4f4881043a56" />
...
```
# Output:
<img width="1609" height="782" alt="image" src="https://github.com/user-attachments/assets/45a31a5e-7cb5-4f32-8ea9-a615b9a47f27" />
...
```
# Output:
<img width="1858" height="847" alt="image" src="https://github.com/user-attachments/assets/1f0b0a8a-5259-499c-ba6b-e3850899ca9b" />
